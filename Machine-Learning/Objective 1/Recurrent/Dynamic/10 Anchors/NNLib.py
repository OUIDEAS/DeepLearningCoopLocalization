...
class NeuralNet(torch.nn.Module):
    ...
    def __init__(self, hidden_size, rnn_layers):
        ...
        hl = [torch.nn.Linear(37, hidden_size), torch.nn.LeakyReLU(negative_slope=0.01)]#,
        ...
        hl2 = [torch.nn.Linear(hidden_size, hidden_size), torch.nn.LeakyReLU(negative_slope=0.01),
               torch.nn.Linear(hidden_size, hidden_size), torch.nn.LeakyReLU(negative_slope=0.01),
