...
class Drone(object):
    ...
    def __init__(self, min_pos=-100, max_pos=100):
        self.min = min_pos
        self.max = max_pos
        self.max_vel = 10
        self.min_vel = -10
...
def main():
    ...
    with open('test_data.csv', 'w', encoding='UTF8') as f:
        ...
        for i in range(100):
            ...
            lat, lon, h = Simulate_GPS(anc_2.x - anc_1.x, anc_2.y - anc_1.y, anc_2.z - anc_1.z)
            x2, y2 = GPS_to_XYZ(lat, lon, anc_2.x - anc_1.x, anc_2.y - anc_1.y)
            z2 = h

            lat, lon, h = Simulate_GPS(anc_3.x - anc_1.x, anc_3.y - anc_1.y, anc_3.z - anc_1.z)
            x3, y3 = GPS_to_XYZ(lat, lon, anc_3.x - anc_1.x, anc_3.y - anc_1.y)
            z3 = h

            lat, lon, h = Simulate_GPS(anc_4.x - anc_1.x, anc_4.y - anc_1.y, anc_4.z - anc_1.z)
            x4, y4 = GPS_to_XYZ(lat, lon, anc_4.x - anc_1.x, anc_4.y - anc_1.y)
            z4 = h

            lat, lon, h = Simulate_GPS(anc_5.x - anc_1.x, anc_5.y - anc_1.y, anc_5.z - anc_1.z)
            x5, y5 = GPS_to_XYZ(lat, lon, anc_5.x - anc_1.x, anc_5.y - anc_1.y)
            z5 = h

            lat, lon, h = Simulate_GPS(anc_6.x - anc_1.x, anc_6.y - anc_1.y, anc_6.z - anc_1.z)
            x6, y6 = GPS_to_XYZ(lat, lon, anc_6.x - anc_1.x, anc_6.y - anc_1.y)
            z6 = h

            lat, lon, h = Simulate_GPS(anc_7.x - anc_1.x, anc_7.y - anc_1.y, anc_7.z - anc_1.z)
            x7, y7 = GPS_to_XYZ(lat, lon, anc_7.x - anc_1.x, anc_7.y - anc_1.y)
            z7 = h

            lat, lon, h = Simulate_GPS(anc_8.x - anc_1.x, anc_8.y - anc_1.y, anc_8.z - anc_1.z)
            x8, y8 = GPS_to_XYZ(lat, lon, anc_8.x - anc_1.x, anc_8.y - anc_1.y)
            z8 = h

            lat, lon, h = Simulate_GPS(anc_9.x - anc_1.x, anc_9.y - anc_1.y, anc_9.z - anc_1.z)
            x9, y9 = GPS_to_XYZ(lat, lon, anc_9.x - anc_1.x, anc_9.y - anc_1.y)
            z9 = h

            lat, lon, h = Simulate_GPS(anc_0.x - anc_1.x, anc_0.y - anc_1.y, anc_0.z - anc_1.z)
            x0, y0 = GPS_to_XYZ(lat, lon, anc_0.x - anc_1.x, anc_0.y - anc_1.y)
            z0 = h
            ...
            data = [r1, r2, r3, r4, r5, r6, r7, r8, r9, r0, x2, y2, z2, x3, y3, z3, x4, y4, z4, x5, y5, z5, x6, y6, z6, 
                    x7, y7, z7, x8, y8, z8, x9, y9, z9, x0, y0, z0, drone.x - anc_1.x, 
