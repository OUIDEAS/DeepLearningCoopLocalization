...
print("ANN")
print(average(results.ANN))
print(stdev(results.ANN))
print(max(results.ANN))

print("TRI")
print(average(results.TRI))
print(stdev(results.TRI))
print(max(results.TRI))
tri = []
ann = []
dop = []
tup = []
...
for i in range(len(cdfann)):
    if cdfann[i] >= 0.895 and cdfann[i] <= 0.905:
